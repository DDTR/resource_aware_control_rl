...
def get_perturbed_actor_updates(actor, perturbed_actor, param_noise_stddev):
    ...
    for var, perturbed_var in zip(actor.vars, perturbed_actor.vars):
        if var in actor.perturbable_vars:
            ...
            updates.append(tf.compat.v1.assign(perturbed_var, var + tf.random.normal(tf.shape(input=var), mean=0., stddev=param_noise_stddev)))
        else:
...
class DDPG(object):
    def __init__(self, actor, critic, memory, observation_shape, action_shape, param_noise=None, action_noise=None,
        ...
        # Inputs.
        self.obs0 = tf.compat.v1.placeholder(tf.float32, shape=(None,) + (observation_shape[0] + action_shape[0],), name='obs0')
        self.obs1 = tf.compat.v1.placeholder(tf.float32, shape=(None,) + (observation_shape[0] + action_shape[0],), name='obs1')
        ...
        self.actions = tf.compat.v1.placeholder(tf.float32, shape=(None,) + (action_shape[0]+2,), name='actions')
    ...
    def setup_critic_optimizer(self):
        ...
        if self.critic_l2_reg > 0.:
            ...
            critic_reg = tensorflow.contrib.layers.apply_regularization(
                tensorflow.contrib.layers.l2_regularizer(self.critic_l2_reg),
